...
class CreateArticle extends Component {
    ...
    render() {
        ...
        return (
            <div className="edit-product"> {/* Cambié el contenedor a la clase edit-product */}
                <h1 className="subheader">Crear Producto</h1>
                <form className="mid-form" onSubmit={this.saveProduct}>
                    ...
                    <button type='button' onClick={() => this.props.history.goBack()} className='btn btn-danger'>Cancelar</button>
                </form>
            </div>
        );
    }
